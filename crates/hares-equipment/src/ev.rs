...
const KEY_BATTERY_CAPACITY_KWH: &str = "capacity_kwh";
const KEY_BATTERY_CAPACITY_HPIXML_KWH: &str = "BatteryCapacity";
const KEY_CHARGING_LEVEL: &str = "charging_level";
const KEY_CHARGING_LEVEL_HPIXML: &str = "ChargingLevel";
const KEY_MAX_CHARGING_POWER_KW: &str = "max_charging_power_kw";
const KEY_MAX_CHARGING_POWER_HPIXML_KW: &str = "MaxChargingPower";
const KEY_VEHICLE_TYPE: &str = "vehicle_type";
const KEY_RANGE_MILES: &str = "range_miles";
const KEY_SCHEDULE_CSV_PATH: &str = "schedule_csv_path";
const KEY_SCHEDULE_CSV_REF: &str = "schedule_csv";
const KEY_EVENT_DAY_RATIO: &str = "event_day_ratio";
const KEY_INITIAL_SOC: &str = "initial_soc";
const KEY_SOC_MAX: &str = "soc_max";
const KEY_EFFICIENCY: &str = "charging_efficiency";
const KEY_SCHEDULE_LEN: &str = "schedule_len";
const KEY_POWER_LIMIT_KW: &str = "power_limit_kw";
const KEY_L1_CURRENT_A: &str = "l1_current_a";
const KEY_L1_VOLTAGE_V: &str = "l1_voltage_v";
...
const KEY_PYBAMM_LUT_PATH: &str = "pybamm_lut_path";
const KEY_BATTERY_TEMP_C: &str = "battery_temp_c";
...
const KEY_THERMAL_MASS_J_PER_K: &str = "thermal_mass_j_per_k";
const KEY_UA_W_PER_K: &str = "ua_w_per_k";
const KEY_DRIVER_ARCHETYPE: &str = "driver_archetype";
const KEY_ARRIVAL_FUZZ_MINUTES: &str = "arrival_fuzz_minutes";
const KEY_DEPARTURE_FUZZ_MINUTES: &str = "departure_fuzz_minutes";
...
const KEY_PLUG_IN_SOC_THRESHOLD: &str = "plug_in_soc_threshold";
...
const EV_FUEL_ECONOMY_KWH_PER_MI: f64 = 0.325;
...
const DEFAULT_CAPACITY_KWH: f64 = 75.0;
const DEFAULT_SOC: f64 = 1.0;
const DEFAULT_SOC_MAX: f64 = 1.0;
const DEFAULT_EFFICIENCY: f64 = 0.9;
const DEFAULT_L1_VOLTAGE_V: f64 = 120.0;
...
const DEFAULT_THERMAL_MASS_J_PER_K: f64 = 20_000.0;
const DEFAULT_UA_W_PER_K: f64 = 4.0;
const DEFAULT_DAILY_DRIVE_MILES_MEAN: f64 = 30.0;
const DEFAULT_DAILY_DRIVE_MILES_STDDEV: f64 = 12.0;
const DEFAULT_PLUG_IN_SOC_THRESHOLD: f64 = 0.3;
const DEFAULT_V2L_SOC_RESERVE: f64 = 0.2;
const DEFAULT_V2L_MAX_DISCHARGE_KW: f64 = 3.0;
const SECONDS_PER_HOUR: f64 = 3600.0;
const SECONDS_PER_DAY: i64 = 86_400;
const MIN_TIMESTEP_HOURS: f64 = 1e-9;
...
#[derive(Clone, Debug)]
struct ChargingCurveLut {
    soc_points: Vec<f64>,
    power_fraction_points: Vec<f64>,
}

impl ChargingCurveLut {
    fn power_fraction_at(&self, soc: f64) -> f64 {
...
fn resolve_capacity_kwh(config: &EquipmentConfig) -> Option<f64> {
    let direct = config
...
fn vehicle_number_from_config(config: &EquipmentConfig, capacity_kwh: f64) -> u8 {
...
fn default_event_day_ratio(capacity_kwh: f64, level: ChargingLevel) -> f64 {
    match level {
...
fn parse_pybamm_lut_csv(path: &Path) -> crate::Result<ChargingCurveLut> {
    if path
        .extension()
...
fn validate_optional_hour(field_name: &str, value: Option<f64>) -> crate::Result<()> {
    if let Some(v) = value
