...
impl OcvTable {
    ...
    fn voltage_at_soc(&self, soc: f64) -> f64 {
...
impl UNegTable {
    ...
    fn potential_at_soc(&self, soc: f64) -> f64 {
        let soc = soc.clamp(self.soc_points[0], *self.soc_points.last().unwrap());
        let n = self.soc_points.len();
        if n == 1 {
...
impl RainflowCounter {
    ...
    fn sum_squared_dod_daily(&self) -> f64 {
...
impl DegradationState {
    ...
    fn accumulate(&mut self, dt_s: f64, cell_temp_k: f64, v_oc: f64, soc: f64) {
        use deg_const::*;
    ...
    fn reset_day_tracking(&mut self, soc: f64) {
        self.soc_max_today = soc;
        self.soc_min_today = soc;
    ...
    fn update_daily(&mut self, u_neg_table: &UNegTable, cell_temp_k: f64, sum_squared_dod: f64) {
        use deg_const::*;
