...
fn build_setpoint_source(config: &EquipmentConfig, prefix: &str) -> Option<ScheduleSource> {
...
mod tests {
    ...
    fn biquadratic_parser_handles_negative_coefficients() {
        ...
        let result = super::parse_biquadratic_list(input).expect("should parse successfully");
