...
- Startup capacity degradation uses the Winkler (2011) exponential ramp model (speed_control.rs:71-97), with c_d=0.0 for variable-speed MSHP (no startup ramp — correct) (cooler.rs:429-430).
Gaps:
