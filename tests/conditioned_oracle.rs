//! Conditioned HVAC ballpark-comparison tests: compare HARES HVAC behavior
//! against OCHRE reference output with equipment active. Ballpark comparison
//! against OCHRE; NOT a correctness oracle -- HARES targets ASHRAE Handbook
//! of Fundamentals and EnergyPlus Engineering Reference physics.
//!
//! Two modes per scenario:
//! - Ideal mode: HARES clears all equipment, injects IdealHvac with solver
//!   back-calculated capacity. Temperature should track setpoint tightly
//!   (< 0.5 C MAE; this is an internal-consistency bound, not an OCHRE bound).
//! - Dynamic mode: HARES keeps native ASHP equipment with on/off thermostat
//!   cycling, stripping non-HVAC equipment to match the OCHRE fixture scope.
//!   Temperature oscillates within the deadband (< 2.0 C MAE vs OCHRE,
//!   grounded in the ASHRAE Standard 152 +/- 1 C single-stage cycling residual
//!   doubled for multi-model thermostat phase offsets).
//!
