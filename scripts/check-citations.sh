...
check_pattern() {
    ...
    if [ ${#FILTERED[@]} -gt 0 ]; then
        ...
        printf '%s\n' "${FILTERED[@]}"
        echo ""
        echo "Correct citation is: Cutler, D., Winkler, J., Kruis, N., Christensen, C.,"
        echo "  Brandemuehl, M. (2013). Improved Modeling of Residential Air Conditioners"
        echo "  and Heat Pumps for Energy Calculations. NREL/TP-5500-56354."
        FAILED=1
    fi
}
